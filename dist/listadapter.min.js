...
return this.scrollTop||(window.pageYOffset||t.scrollTop)-(t.clientTop||0)},HTMLDocument.prototype.getScrollLeft=HTMLElement.prototype.getScrollLeft=function(){var t=document.documentElement
...
if(this.isMultiType){if(0==t)return this.itemsY[t]=0
var e=this.itemTypeResolver(t-1,this.items[t-1])
return this.itemsY[t]=this.getPositionForItem(t-1)+this.itemsByType[e].height}return this.itemsY[t]=t*this.itemHeight},ListAdapter.prototype.getItemForPosition=function(t){for(var e=0;e<this.items.length;e++){var i=this.getPositionForItem(e)
...
i.style.top=this.offsetTop+this.getPositionForItem(s),this.itemLoadHandler(i.viewHolder,s,this.items[s],i.viewHolder.itemType)}}
